...
fn main() {
    ...
    gui.load_font(&mut rl, &thread, "default", "/home/perococco/Downloads/FreckleFace-Regular.ttf", 48, 200);
    gui.load_font(&mut rl, &thread, "small", "/home/perococco/Downloads/FreckleFace-Regular.ttf", 20, 200);
