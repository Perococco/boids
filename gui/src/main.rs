...
//        let font = rl.load_font_ex(&thread,"/home/perococco/Downloads/FreckleFace-Regular.ttf",48,FontLoadEx::Default(200)).unwrap();
//    let font = rl.load_font_ex(&thread,"/home/perococco/Downloads/pixantiqua.ttf",48,FontLoadEx::Default(80)).unwrap();


    let mut gui  = create_gui();


    let id = gui.load_font(&mut rl,&thread,"/home/perococco/Downloads/FreckleFace-Regular.ttf",48,200).unwrap();
